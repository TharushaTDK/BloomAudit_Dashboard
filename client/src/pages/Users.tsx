            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700/60">
                  ...
                  <th className="text-left text-slate-400 text-xs font-medium px-4 py-3">Users</th>
              ...
              <tbody className="divide-y divide-slate-700/40">
                {users.map(user => (
                  <tr key={user.id} className="hover:bg-slate-700/20 transition-colors">
                    ...
                    <td className="px-4 py-3 text-slate-300 text-sm">{user.company_type || '—'}</td>
                    <td className="px-4 py-3">
                      <span className={`px-2.5 py-1 rounded-lg text-xs font-medium ${packageColors[user.package_name] || 'bg-slate-700 text-slate-300'}`}>
                        {user.package_name || '—'}
                      </span>
                    </td>
                    <td className="px-4 py-3 text-slate-300 text-sm">{user.no_of_users ?? '—'}</td>
                    <td className="px-4 py-3">
